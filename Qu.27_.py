# Q27. Write a function for checking the speed of drivers. This function should have 
# one parameter: speed.
...
# 3.If the driver gets more than 12 points, the function should print: “License 
# suspended”
